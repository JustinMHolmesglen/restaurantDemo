    ...
    <Fragment>
      <Container>
        ...
        <div className="row mb-3">
         ...
         <div className="row mb-3">
          <div className="col-md-12"><img src="/menu1.jpg" alt="Menu1" /></div>
        </div>
        <div className="row mb-3">
          <div className="col-md-12"><img src="/menu2.jpg" alt="Menu2"/></div>
        </div>
        <div className="row mb-3">
          <div className="col-md-12"><img src="/menu3.jpg" alt="Menu3" /></div>
        </div>
        <div className="row mb-3">
         ...
         <div className="row mb-3">
          <div className="col-md-12"><img src="/menuSpecials.jpg" alt="Menu Specials" /></div>
        </div>
