  ...
  return (
    <Fragment>
      <Container>
        ...
        <div className="row mb-3">
          <div className="col-md-6"><img src="../../src/assets/spice_pic.jpg" alt="Food-gallery-2" /></div>
          <div className="col-md-6"><img src="../../src/assets/prawns_pic.jpg" alt="Food-gallery-1"/></div>
        </div>
